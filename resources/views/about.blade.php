...
@section('content')
    ...
    <section class="vs-about space space-bottom z-index-common overflow-hidden">
            ...
            <div class="row gx-60">
                ...
                <div class="col-lg-6 mb-30">
                    <div class="vs-about__content">
                        <div class="title-area title-area--style6 mb-4"><span class="title-area__title--sub"><img src="assets/img/icons/vs-icon-title-h6-1.svg" alt="vs-icon-title-star"> About US <img src="assets/img/icons/vs-icon-title-h6-1.svg" alt="vs-icon-title-star"></span>
                        ...
                        <p class="vs-about__text style2 text-white">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.”</p>
                        <div class="vs-about__footer"><a href="blog-details.html" class="vs-btn vs-btn--style13">Explore More</a>
                            <div class="vs-info style9 d-none d-xl-flex">
                                <div class="vs-info__icon--box"><i class="vs-info__icon"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30 12.5V17.5C30 18.8789 28.8789 20 27.5 20H26.8193C25.8633 25.666 20.9346 30 15 30C14.4473 30 14 29.5527 14 29C14 28.4473 14.4473 28 15 28C20.5137 28 25 23.5137 25 18V12C25 6.48633 20.5137 2 15 2C9.48633 2 5 6.48633 5 12V19C5 19.5527 4.55273 20 4 20H2.5C1.12109 20 0 18.8789 0 17.5V12.5C0 11.1211 1.12109 10 2.5 10H3.18066C4.13672 4.33398 9.06543 0 15 0C20.9346 0 25.8633 4.33398 26.8193 10H27.5C28.8789 10 30 11.1211 30 12.5ZM15 4C10.5889 4 7 7.58887 7 12V17C7 21.4111 10.5889 25 15 25C19.4111 25 23 21.4111 23 17V12C23 7.58887 19.4111 4 15 4Z" fill="#FACF61"/></svg></i></div>
                                <div
                                class="vs-info__content">
                                    <h6 class="vs-info__title">Call Us Any Time</h6><a class="vs-info__label" href="tel:+0019280009">+(00) 1928 0009</a></div>
                        </div>
                    </div>
                </div>
            </div>
     ...
     <section class="vs-team space space-bottom">
        <div class="container">
            <div class="row gx-60 gy-5 align-items-center">
                <div class="col-lg-6">
                    <div class="vs-team__big-img"><img src="assets/img/team/team-big-img-1.jpg" alt="Team Big Image"></div>
                </div>
                <div class="col-lg-6">
                    <div class="vs-team__details-content">
                        <div class="vs-team__details-header mb-45">
                            <div class="vs-team__details-desig">
                                <h4 class="vs-team__details-name">Rivanur R. Rafi</h4><span class="vs-team__details-role">Designer, BigBiz</span></div>
                            <div class="vs-team__details-social">
                                <div class="social-style style7"><a href="#"><i class="fab fa-facebook-f"></i></a> <a href="#"><i class="fab fa-linkedin-in"></i></a> <a href="#"><i class="fab fa-instagram"></i></a></div>
                            </div>
                        </div>
                        <p class="mb-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor inc didunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        <table>
                            <tr>
                                <th>Experience</th>
                                <td>10 Years Plus Experience</td>
                            </tr>
                            <tr>
                                <th>Department</th>
                                <td>Designer, BigBiz</td>
                            </tr>
                            <tr>
                                <th>Address</th>
                                <td>Chicago 935 W. Chestnut Street Ste LL12</td>
                            </tr>
                            <tr>
                                <th>Email</th>
                                <td>rivanur@example.com</td>
                            </tr>
                            <tr>
                                <th>Phone</th>
                                <td>+00 (999) 3322 7080</td>
                            </tr>
                        </table>
                        <h4>Skill</h4>
                        <div class="progress-box style2">
                            <div class="progress-box__header">
                                <h3 class="progress-box__title">IT Innovation</h3><span class="progress-box__number">80%</span></div>
                            <div class="progress-box__progress">
                                <div class="progress-box__bar bg-color1" role="progressbar" data-width="80" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;"></div>
                            </div>
                        </div>
                        <div class="progress-box style2 mt-30">
                            <div class="progress-box__header">
                                <h3 class="progress-box__title">IT Innovation</h3><span class="progress-box__number">80%</span></div>
                            <div class="progress-box__progress">
                                <div class="progress-box__bar bg-color1" role="progressbar" data-width="80" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;"></div>
            ...
            <div class="vs-team__describe space-extra-top">
                <h4 class="mb-20">About Rivanur R. Rafi</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                <div
                class="pt-20">
                    <h4 class="mb-20">Personal Experience</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    <ul
                    class="vs-list">
                        <li>Duis aute irure dolor in reprehenderit in voluptate velit esse.</li>
                        <li>Cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.</li>
                        <li>Fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia.</li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="title-area title-area--style5 text-center mb-20"><span class="title-area__title--sub text-white"><img src="assets/img/icons/vs-icon-sec-h5-1.svg" alt="Icon"> Our Features <img src="assets/img/icons/vs-icon-sec-h5-1.svg" alt="Icon"></span>
                        <h2 class="title-area__title text-white">Key Features of BigBiz EV Charging</h2></div>
                </div>
            </div>
            <div class="vs-features__wrapper" data-bg-src="assets/img/elements/vs-featured-bg.svg">
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-6 col-lg-4 order-0">
                        ...
                        <div class="vs-features__charging">
                            <div class="vs-features__charging-icon"><i class="flaticon flaticon-global"></i></div>
                            <h3 class="vs-features__charging-title">Global Compatibility</h3>
                            <p class="vs-features__charging-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                        </div>
                    </div>
                    <div class="col-lg-auto order-2 order-lg-1">
                        <div class="vs-features__img"><img src="assets/img/features/h5-features-1.png" alt="vs-features"></div>
                    </div>
                    <div class="col-md-6 col-lg-4 order-1 order-lg-2">
                        ...
                        <div class="vs-features__charging vs-features__charging--right">
                            <div class="vs-features__charging-icon"><i class="flaticon flaticon-friends"></i></div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="vs-team__item vs-team__item--style3 social-clickable">
                            ...
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href="team-details.html"><img class="vs-team__item-img" src="assets/img/team/team-member-h2-1.jpg" alt="Team Member Image"></a>
                            </figure>
                    ...
                    <div class="swiper-slide">
                        <div class="vs-team__item vs-team__item--style3 social-clickable">
                            ...
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href="team-details.html"><img class="vs-team__item-img" src="assets/img/team/team-member-h2-2.jpg" alt="Team Member Image"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                                    <h3 class="vs-team__item-name"><a href="team-details.html">Emma Watson</a></h3><a href="team-details.html" class="vs-team__item-role">Designer, BigBiz</a></div>
                    ...
                    <div class="swiper-slide">
                        <div class="vs-team__item vs-team__item--style3 social-clickable">
                            ...
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href="team-details.html"><img class="vs-team__item-img" src="assets/img/team/team-member-h2-3.jpg" alt="Team Member Image"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                                    <h3 class="vs-team__item-name"><a href="team-details.html">Emma Watson</a></h3><a href="team-details.html" class="vs-team__item-role">Designer, BigBiz</a></div>
                    ...
                    <div class="swiper-slide">
                        <div class="vs-team__item vs-team__item--style3 social-clickable">
                            ...
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href="team-details.html"><img class="vs-team__item-img" src="assets/img/team/team-member-h2-4.jpg" alt="Team Member Image"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                                    <h3 class="vs-team__item-name"><a href="team-details.html">Emma Watson</a></h3><a href="team-details.html" class="vs-team__item-role">Designer, BigBiz</a></div>
                    ...
                    <div class="accordion style3" id="faqVersion1">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#faqVersion1">
                                <div class="accordion-body">No! Financial planning is essential for everyone, regardless of income level. Whether you’re just starting your financial journey or managing significant assets, we offer customized solutions to help you achieve financial
