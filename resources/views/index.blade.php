                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.2" data-duration="1">
                        <div class="vs-team__item vs-team__item--style2 vs-active">
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href=""><img class="vs-team__item-img" src="{{ asset('assets/img/services/Startup_&_Enterprise.webp') }}" alt="Startup & Enterprise"></a>
                            </figure>
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.2" data-duration="1">
                        <div class="vs-team__item vs-team__item--style2 vs-active active">
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href=""><img class="vs-team__item-img" src="{{ asset('assets/img/services/Finance_&_Business.webp') }}" alt="CRM & Digital Marketing Solutions"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.2" data-duration="1">
                        <div class="vs-team__item vs-team__item--style2 vs-active">
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href=""><img class="vs-team__item-img" src="{{ asset('assets/img/services/Retail_&_eCommerce.webp') }}" alt="Online Store & Web Solutions"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.2" data-duration="1">
                        <div class="vs-team__item vs-team__item--style2 vs-active">
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href=""><img class="vs-team__item-img" src="{{ asset('assets/img/services/Real_Estate_Services.webp') }}" alt="Real Estate Services"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.2" data-duration="1">
                        <div class="vs-team__item vs-team__item--style2 vs-active">
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href=""><img class="vs-team__item-img" src="{{ asset('assets/img/services/Healthcare_&_Clinics.webp') }}" alt="Healthcare & Clinics"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.2" data-duration="1">
                        <div class="vs-team__item vs-team__item--style2 vs-active">
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href=""><img class="vs-team__item-img" src="{{ asset('assets/img/services/Education_&_Training.webp') }}" alt="Education & Training"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.2" data-duration="1">
                        <div class="vs-team__item vs-team__item--style2 vs-active">
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href=""><img class="vs-team__item-img" src="{{ asset('assets/img/services/Manufacturing_Sector.webp') }}" alt="Manufacturing Sector"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.2" data-duration="1">
                        <div class="vs-team__item vs-team__item--style2 vs-active">
                            <figure class="vs-team__item-figure">
                                <a class="vs-team__item-img-link" href=""><img class="vs-team__item-img" src="{{ asset('assets/img/services/Hotels_&_Restaurants.webp') }}" alt="Hotels & Restaurants"></a>
                            </figure>
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                ...
                <div class="vs-portfolio__grids row grid">
                    ...
                    <div class="vs-portfolio__item vs-portfolio__item--style2 grid-item col-lg-4 col-md-6 brand vs-fade-in-up" data-duration="1" data-delay="0.3">
                        <div class="vs-portfolio__content">
                            <a class="vs-portfolio__link--img d-inline-block" href=""><img src="{{ asset('assets/img/portfolio/Our_Core_Expertise_1.webp') }}" class="vs-portfolio__img" alt="Portfolio Item 1"></a>
                            <div class="vs-portfolio__item-overlay">
                                <div class="vs-portfolio__item-text"><a href="" class="vs-portfolio__item-tag">Website Development</a>
                                    <h3 class="vs-portfolio__item-heading"><a href="" class="vs-portfolio__item-heading__link">Custom Business Website Development</a></h3></div>
                            </div>
                        </div>
                    </div>
                    <div class="vs-portfolio__item vs-portfolio__item--style2 grid-item col-lg-4 col-md-6 mockup vs-fade-in-up" data-duration="1" data-delay="0.4">
                        <div class="vs-portfolio__content">
                            <a class="vs-portfolio__link--img d-inline-block" href=""><img src="{{ asset('assets/img/portfolio/Our_Core_Expertise_2.webp') }}" class="vs-portfolio__img vs-image-effect__image" alt="Portfolio Item 1"></a>
                            <div class="vs-portfolio__item-overlay">
                                <div class="vs-portfolio__item-text"><a href="" class="vs-portfolio__item-tag">Software Development</a>
                                    <h3 class="vs-portfolio__item-heading"><a href="" class="vs-portfolio__item-heading__link">ERP & CRM Software Development</a></h3></div>
                            </div>
                        </div>
                    </div>
                    <div class="vs-portfolio__item vs-portfolio__item--style2 grid-item col-lg-4 col-md-6 logo vs-fade-in-up" data-duration="1" data-delay="0.5">
                        <div class="vs-portfolio__content">
                            <a class="vs-portfolio__link--img d-inline-block" href=""><img src="{{ asset('assets/img/portfolio/Our_Core_Expertise_3.webp') }}" class="vs-portfolio__img" alt="Portfolio Item 1"></a>
                            <div class="vs-portfolio__item-overlay">
                                <div class="vs-portfolio__item-text"><a href="" class="vs-portfolio__item-tag">Mobile Apps</a>
                                    <h3 class="vs-portfolio__item-heading"><a href="" class="vs-portfolio__item-heading__link">Android & iOS App Development</a></h3></div>
                            </div>
                        </div>
                    </div>
                    <div class="vs-portfolio__item vs-portfolio__item--style2 grid-item col-lg-4 col-md-6 consulting vs-fade-in-up" data-duration="1" data-delay="0.6">
                        <div class="vs-portfolio__content">
                            <a class="vs-portfolio__link--img d-inline-block" href=""><img src="{{ asset('assets/img/portfolio/Our_Core_Expertise_4.webp') }}" class="vs-portfolio__img" alt="Portfolio Item 1"></a>
                            <div class="vs-portfolio__item-overlay">
                                <div class="vs-portfolio__item-text"><a href="" class="vs-portfolio__item-tag">SEO Services</a>
                                    <h3 class="vs-portfolio__item-heading"><a href="" class="vs-portfolio__item-heading__link">Search Engine Optimization Services</a></h3></div>
                            </div>
                        </div>
                    </div>
                    <div class="vs-portfolio__item vs-portfolio__item--style2 grid-item col-lg-4 col-md-6 brand vs-fade-in-up" data-duration="1" data-delay="0.7">
                        <div class="vs-portfolio__content">
                            <a class="vs-portfolio__link--img d-inline-block" href=""><img src="{{ asset('assets/img/portfolio/Our_Core_Expertise_5.webp') }}" class="vs-portfolio__img" alt="Portfolio Item 1"></a>
                            <div class="vs-portfolio__item-overlay">
                                <div class="vs-portfolio__item-text"><a href="" class="vs-portfolio__item-tag">Digital Marketing</a>
                                    <h3 class="vs-portfolio__item-heading"><a href="" class="vs-portfolio__item-heading__link">Digital Marketing & Lead Generation</a></h3></div>
                            </div>
                        </div>
                    </div>
                    <div class="vs-portfolio__item vs-portfolio__item--style2 grid-item col-lg-4 col-md-6 logo mockup vs-fade-in-up" data-duration="1" data-delay="0.8">
                        <div class="vs-portfolio__content">
                            <a class="vs-portfolio__link--img d-inline-block" href=""><img src="{{ asset('assets/img/portfolio/Our_Core_Expertise_6.webp') }}" class="vs-portfolio__img" alt="Portfolio Item 1"></a>
                            <div class="vs-portfolio__item-overlay">
                                <div class="vs-portfolio__item-text"><a href="" class="vs-portfolio__item-tag">Software Development</a>
                                    <h3 class="vs-portfolio__item-heading"><a href="" class="vs-portfolio__item-heading__link">Custom Business Software Solutions</a></h3></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="vs-carousel swiper vs-active-wrapper" data-xl="3" data-lg="2" data-space-xl="30" data-loop="false" data-autoplay="false">
                <div class="swiper-wrapper">
                    <div class="swiper-slide vs-fade-in-up" data-duration="1" data-delay="0.3" data-yposition="80">
                        <div class="vs-blog vs-blog--style3 vs-image-effect vs-active"><span class="vs-blog__date">16 <sub>Jan</sub></span>
                            <figure class="vs-blog__figure">
                                <a class="vs-blog__figure__link" href="" data-cursor-style="default" data-cursor-text="View!" data-cursor-bg="#196164" data-cursor-size="60px" data-cursor-blend="normal"><img class="vs-blog__img vs-image-effect__image" src="assets/img/blog/vs-blog-h1-1.jpg" alt="Blog Image">
                                    <div class="vs-image-effect__overlay"></div>
                                </a>
                            </figure>
                            <div class="vs-blog__content">
                                <div class="vs-blog__meta"><a href="" class="vs-blog__meta__text"><i class="fa-solid fa-user"></i> By Admin </a><a href="" class="vs-blog__meta__text"><i class="fa-solid fa-comments"></i> (03) Comments</a></div>
                                <h3
                                class="vs-blog__title"><a class="vs-blog__title__link" href="">Lorem ipsum dolor sit amet consectetur.</a></h3>
                                    <hr class="vs-blog__divider">
                                    <div class="vs-blog__buttons"><a href="" class="vs-btn vs-blog__button">Read More <i class="fa-solid fa-arrow-right"></i></a>
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-duration="1" data-delay="0.5" data-yposition="80">
                        <div class="vs-blog vs-blog--style3 vs-image-effect vs-active active"><span class="vs-blog__date">16 <sub>Jan</sub></span>
                            <figure class="vs-blog__figure" data-cursor-style="default" data-cursor-text="View!" data-cursor-bg="#196164" data-cursor-size="60px" data-cursor-blend="normal">
                                <a class="vs-blog__figure__link" href=""><img class="vs-blog__img vs-image-effect__image" src="assets/img/blog/vs-blog-h1-2.jpg" alt="Blog Image">
                                    <div class="vs-image-effect__overlay"></div>
                                </a>
                            </figure>
                            <div class="vs-blog__content">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-duration="1" data-delay="0.7" data-yposition="80">
                        <div class="vs-blog vs-blog--style3 vs-image-effect vs-active"><span class="vs-blog__date">16 <sub>Jan</sub></span>
                            <figure class="vs-blog__figure" data-cursor-style="default" data-cursor-text="View!" data-cursor-bg="#196164" data-cursor-size="60px" data-cursor-blend="normal">
                                <a class="vs-blog__figure__link" href=""><img class="vs-blog__img vs-image-effect__image" src="assets/img/blog/vs-blog-h1-3.jpg" alt="Blog Image">
                                    <div class="vs-image-effect__overlay"></div>
                                </a>
                            </figure>
                            <div class="vs-blog__content">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-duration="1" data-delay="0.7" data-yposition="80">
                        <div class="vs-blog vs-blog--style3 vs-image-effect vs-active"><span class="vs-blog__date">16 <sub>Jan</sub></span>
                            <figure class="vs-blog__figure" data-cursor-style="default" data-cursor-text="View!" data-cursor-bg="#196164" data-cursor-size="60px" data-cursor-blend="normal">
                                <a class="vs-blog__figure__link" href=""><img class="vs-blog__img vs-image-effect__image" src="assets/img/blog/vs-blog-h1-4.jpg" alt="Blog Image">
                                    <div class="vs-image-effect__overlay"></div>
                                </a>
                            </figure>
                            <div class="vs-blog__content">
