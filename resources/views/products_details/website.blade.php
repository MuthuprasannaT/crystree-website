...
<div class="breadcrumb-wrapper z-index-common overflow-hidden" class="" data-bg-src="{{ asset('assets/img/bg/website-development.webp')}}" loading="lazy">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="vs-blog vs-blog--single">
                        <figure class="vs-blog__figure"><img class="vs-blog__img" src="{{ asset('assets/img/blog/best-website-company.webp')}}" alt="best-website-company" loading="lazy">
                            <div class="overlay"></div>
                        </figure>
                            ...
                            <div class="row pt-30">
                                <div class="col-md-6 mb-25">
                                    <div class="vs-blog__video">
                                        <div class="overlay"></div><img src="{{ asset('assets/img/blog/low-price-website.webp')}}" alt="low-price-website" loading="lazy"></div>
                                </div>
                                <div class="col-md-6 mb-25">
                                    <div class="vs-blog__video">
                                        <div class="overlay"></div><img src="{{ asset('assets/img/blog/website-company.webp')}}" alt="website-company" loading="lazy"></div>
                                </div>
                            </div>
