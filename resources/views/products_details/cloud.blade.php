...
<div class="breadcrumb-wrapper z-index-common overflow-hidden" data-bg-src="{{ asset('assets/img/bg/cloud-banner.webp')}}" loading="lazy">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="vs-blog vs-blog--single">
                        <figure class="vs-blog__figure"><img class="vs-blog__img" src="{{ asset('assets/img/blog/cloud-solution.webp')}}" alt="Blog Image" loading="lazy">
                            <div class="overlay"></div>
                        </figure>
                        <div class="vs-blog__content">
                            <h3 class="vs-blog__title mb-2">Cloud Support Services</h3>
                            ...
                            <div class="row pt-30">
                                <div class="col-md-6 mb-25">
                                    <div class="vs-blog__video">
                                        <div class="overlay"></div><img src="{{ asset('assets/img/blog/cloud-area.webp')}}" alt="video" loading="lazy"></div>
                                </div>
                                <div class="col-md-6 mb-25">
                                    <div class="vs-blog__video">
                                        <div class="overlay"></div><img src="{{ asset('assets/img/blog/cloud-network.webp')}}" alt="video" loading="lazy"></div>
                                </div>
                            </div>
<!-- FAQ Section Start -->
<div class="row  mt-10 ">
