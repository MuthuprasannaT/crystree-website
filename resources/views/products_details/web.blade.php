            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="vs-blog vs-blog--single">
                        <figure class="vs-blog__figure"><img class="vs-blog__img" src="{{ asset('assets/img/blog/web-application.webp')}}" alt="Blog Image" loading="lazy">
                            <div class="overlay"></div>
                        </figure>
                            ...
                            <div class="row pt-30">
                                <div class="col-md-6 mb-25">
                                    <div class="vs-blog__video">
                                        <div class="overlay"></div><img src="{{ asset('assets/img/blog/web-application-trichy.webp')}}" alt="video" loading="lazy"></div>
                                </div>
                                <div class="col-md-6 mb-25">
                                    <div class="vs-blog__video">
                                        <div class="overlay"></div><img src="{{ asset('assets/img/blog/website-trichy.webp')}}" alt="video" loading="lazy"></div>
                                </div>
                            </div>
            <!-- FAQ Section Start -->
<div class="row  mt-10 ">
