<!doctype html>
<html class="no-js" lang="zxx" dir="ltr" data-theme="light">
<!-- Mirrored from html.vecurosoft.com/bigbiz/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jun 2026 06:43:21 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>BigBiz - Multipurpose Business HTML5 Template - Home Style 1</title>
    <meta name="author" content="Vecuro">
    <meta name="description" content="BigBiz - Multipurpose Business HTML5 Template">
...
<body class="page vs-home1">
        ...
        <div class="vs-menu-area text-center">
            ...
            <div class="vs-mobile-menu">
                <ul>
                    ...
                    <li class="menu-item-has-children"><a href="shop.html">Pages</a>
                        <ul class="sub-menu">
        ...
        <div class="sidemenu-content">
            ...
            <div class="sidemenu-inner">
                <div class="sidemenu-body">
                    <p class="sidemenu-item text-white mb-30">We are constantly expanding the range of services offered, taking care of children of all ages.</p>
                    <h4 class="sidemenu-subtitle sidemenu-item">CONTACT US</h4>
                    <div class="sidemenu-contact">
                        <ul>
                            <li class="sidemenu-item"><a href="tel:+95552247849" class="sidemenu-link">+9 555 224 7849</a></li>
                            <li class="sidemenu-item"><a href="mailto:info@toddly.com" class="sidemenu-link">info@toddly.com</a></li>
                            <li class="sidemenu-item"><a href="index.html">Munich Expresswa 70 Germany, TX 7859</a></li>
                        </ul>
                    </div>
                ...
                <div class="sidemenu-footer">
                    <hr class="sidemenu-hr sidemenu-item">
                    <div class="footer-social sidemenu-item"><span>follow us on :</span> <a href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a> <a href="https://twitter.com/"><i class="fa-brands fa-x-twitter"></i></a> <a href="https://instagram.com/"><i class="fab fa-instagram"></i></a>                        <a href="https://behance.com/"><i class="fab fa-behance"></i></a></div>
                </div>
            </div>
        </div>
    </div>
    <div id="customCursor" data-cursor-blend="difference"></div>
    ...
    <header class="vs-header">
        ...
        <div id="topbar-wrap" class="vs-header__top">
            <div class="container">
                <div class="row align-items-center justify-content-between gy-1 text-center text-lg-start">
                    <div class="col-lg-auto d-none d-lg-block">
                        <div class="d-flex align-items-center flex-wrap gap-4">
                            <div class="vs-header__info"><i class="fa-solid fa-location-dot"></i> <span><a href="#">Willow Creek Ranch, Colorado, USA</a></span></div>
                            <div class="vs-header__info"><i class="fa-solid fa-envelope"></i> <span><a href="mailto:info@bigbiz.com">info@bigbiz.com</a></span></div>
                        </div>
                    </div>
                    <div class="col-lg-auto">
                        <div class="vs-header__top--right">
                            <div class="dropdown vs-download--options"><a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"><span class="globe-icon"><i class="fal fa-globe"></i></span>English</a>
                            ...
                            <div class="vs-header__top--right__divider"></div>
                            <div class="social-style"><a href="#"><i class="fab fa-facebook-f"></i></a> <a href="#"><i class="fab fa-linkedin-in"></i></a> <a href="#"><i class="fab fa-instagram"></i></a> <a href="#"><i class="fab fa-youtube"></i></a></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row justify-content-between align-items-center gx-sm-0">
                            ...
                            <div class="col-lg-auto flex-grow-1 col-auto d-none d-lg-block">
                                <nav class="main-menu d-none d-lg-block">
                                    <ul>
                                        <li class="menu-item-has-children"><a class="menu-item-has-children__link active" href="index.html">HOME</a>
                                            <ul class="sub-menu">
                                                <li><a href="index.html">Home 01</a></li>
                                                <li><a href="index-2.html">Home 02</a></li>
                                                <li><a href="index-3.html">Home 03</a></li>
                                        ...
                                        <li><a class="menu-item-has-children__link" href="about.html">About</a></li>
                                        <li class="menu-item-has-children"><a class="menu-item-has-children__link" href="service.html">Services</a>
                                            <ul class="sub-menu">
                                                <li><a href="service.html">Service</a></li>
                                                <li><a href="service-details.html">Service Details</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children mega-menu-wrap"><a class="menu-item-has-children__link" href="javascript:void(0)">Pages</a>
                                            <ul class="mega-menu">
                                        ...
                                        <li class="menu-item-has-children"><a class="menu-item-has-children__link" href="blog.html">Blog</a>
                                            <ul class="sub-menu">
                                                <li><a href="blog.html">Blog</a></li>
                                                <li><a href="blog-details.html">Blog Details</a></li>
                                            </ul>
                                        </li>
                                        <li><a class="menu-item-has-children__link" href="contact.html">contact</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <div class="col-lg-auto col-auto">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="vs-hero__content text-center">
                        <h1 class="vs-hero__title vs_fade_anim" data-delay=".3" data-fade-from="bottom" data-duration="1">We Take Care Of Your <span>Brand</span></h1><span class="vs-hero__text vs_fade_anim" data-delay=".5" data-fade-from="bottom" data-duration="1"><span>A business consultant</span> is a professional provides</span>
                        <form class="vs-hero__form vs-form-valid vs_fade_anim" data-delay=".7"
                        data-fade-from="bottom" data-duration="1" action="https://html.vecurosoft.com/bigbiz/demo/mail.php" method="post">
                            <input class="vs-hero__form--input" type="text" placeholder="Enter Your Email" name="email" autocomplete="email">
                            <button type="submit" class="vs-hero__form--btn" type="button" name="submit">Let’s Talk</button>
                        </form>
    ...
    <div class="vs-brand" dir="ltr">
        <div class="container vs-brand__container">
            <div class="vs-brand__content z-index-common bg-theme">
                <div class="vs-brand__ele vs-brand__ele--left"></div>
    ...
    <section class="vs-about space space-extra-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-30">
                    <div class="vs-about__content">
                        ...
                        <p class="vs-about__text">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.”</p>
                            ...
                            <div class="vs-about__facts">
                                ...
                                <div class="vs-about__facts-content main-counter" data-counter="2000" data-format="comma">
                                    <div class="vs-about__facts-number">
                                        <p class="main-counter__number">0</p>+</div><span class="vs-about__facts-title">Happy Clients</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="vs-service__grid-item active vs-fade-in-up">
                    <div class="vs-service__card">
                        ...
                        <div class="vs-service__card-content">
                            ...
                            <div
                            class="vs-service__card-icon"><i class="flaticon flaticon-target-market"></i></div>
                    </div>
                </div>
            </div>
            <div class="vs-service__grid-item vs-fade-in-up">
                <div class="vs-service__card">
                    ...
                    <div class="vs-service__card-content">
                        ...
                        <p class="vs-service__card-text">Lorem ipsum dolor sit amet, conse pns elit. Ut elit tellus, luctus nec corper matis, pulvinar dapibus leo.</p><a href="service-details.html" class="vs-service__card-link"><span class="vs-service__card-link__text">View Details </span><i class="fa-solid fa-arrow-right"></i></a>
                        <div
                        class="vs-service__card-icon"><i class="flaticon flaticon-layer"></i></div>
                </div>
            </div>
        </div>
        <div class="vs-service__grid-item vs-fade-in-up">
            <div class="vs-service__card">
                ...
                <div class="vs-service__card-content">
                    ...
                    <p class="vs-service__card-text">Lorem ipsum dolor sit amet, conse pns elit. Ut elit tellus, luctus nec corper matis, pulvinar dapibus leo.</p><a href="service-details.html" class="vs-service__card-link"><span class="vs-service__card-link__text">View Details </span><i class="fa-solid fa-arrow-right"></i></a>
                    <div
                    class="vs-service__card-icon"><i class="flaticon flaticon-brand"></i></div>
            </div>
        </div>
        </div>
        </div>
            ...
            <div class="vs-service__grid-item vs-fade-in-up">
                <div class="vs-service__card">
                    ...
                    <div class="vs-service__card-content">
                        ...
                        <p class="vs-service__card-text">Lorem ipsum dolor sit amet, conse pns elit. Ut elit tellus, luctus nec corper matis, pulvinar dapibus leo.</p><a href="service-details.html" class="vs-service__card-link"><span class="vs-service__card-link__text">View Details </span><i class="fa-solid fa-arrow-right"></i></a>
                        <div
                        class="vs-service__card-icon"><i class="flaticon flaticon-promotion"></i></div>
                </div>
            </div>
        </div>
        <div class="vs-service__grid-item vs-fade-in-up">
            <div class="vs-service__card">
                ...
                <div class="vs-service__card-content">
                    ...
                    <p class="vs-service__card-text">Lorem ipsum dolor sit amet, conse pns elit. Ut elit tellus, luctus nec corper matis, pulvinar dapibus leo.</p><a href="service-details.html" class="vs-service__card-link"><span class="vs-service__card-link__text">View Details </span><i class="fa-solid fa-arrow-right"></i></a>
                    <div
                    class="vs-service__card-icon"><i class="flaticon flaticon-consultant"></i></div>
            </div>
        </div>
        </div>
        <div class="vs-service__grid-item active vs-fade-in-up">
            <div class="vs-service__card">
                ...
                <div class="vs-service__card-content">
                    ...
                    <p class="vs-service__card-text">Lorem ipsum dolor sit amet, conse pns elit. Ut elit tellus, luctus nec corper matis, pulvinar dapibus leo.</p><a href="service-details.html" class="vs-service__card-link"><span class="vs-service__card-link__text">View Details </span><i class="fa-solid fa-arrow-right"></i></a>
                    <div
                    class="vs-service__card-icon"><i class="flaticon flaticon-branding"></i></div>
            </div>
        </div>
        </div>
        </div>
    ...
    <section class="vs-team space space-extra-bottom">
        <div class="container">
            ...
            <div class="vs-carousel swiper" data-xl="3" data-lg="3" data-md="2" data-autoplay="false" dir="ltr">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide vs-fade-in-up" data-delay="0.4" data-duration="1">
                        <div class="vs-team__item">
                            ...
                            <div class="vs-team__item-body">
                                <div class="vs-team__item-content">
                                    <h3 class="vs-team__item-name"><a href="team-details.html">Rivanur R. Rafi</a></h3><a href="team-details.html" class="vs-team__item-role">CEO, BigBiz</a></div>
                                <div class="vs-team__item-social"><a href="#"><i class="fab fa-facebook-f"></i></a> <a href="#"><i class="fab fa-linkedin-in"></i></a> <a href="#"><i class="fab fa-instagram"></i></a></div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="vs-counter vs-counter--layout1" dir="ltr">
        <div class="container">
            <div class="vs-counter__inner z-index-common">
                <div class="vs-brand__ele vs-brand__ele--left"></div>
                <div class="vs-brand__ele vs-brand__ele--right"></div>
                <div class="row gx-0">
                    <div class="col-lg-3 vs-counter__col">
                        <div class="vs-counter__box main-counter" data-counter="20">
                            <div class="vs-counter__header">
                                <div class="vs-counter__number">
                                    <p class="main-counter__number">0</p>k+</div>
                            </div>
                            <h3 class="vs-counter__title">Successful Project</h3></div>
                    </div>
                    <div class="col-lg-3 vs-counter__col">
                        <div class="vs-counter__box main-counter" data-counter="99">
                            <div class="vs-counter__header">
                                <div class="vs-counter__number">
                                    <p class="main-counter__number">0</p>+</div>
                            </div>
                            <h3 class="vs-counter__title">Award Wins</h3></div>
                    </div>
                    <div class="col-lg-3 vs-counter__col">
                        <div class="vs-counter__box main-counter" data-counter="100">
                            <div class="vs-counter__header">
                                <div class="vs-counter__number">
                                    <p class="main-counter__number">0</p>+</div>
                            </div>
                            <h3 class="vs-counter__title">Team Members</h3></div>
                    </div>
                    <div class="col-lg-3 vs-counter__col">
                        <div class="vs-counter__box main-counter" data-counter="12">
                            <div class="vs-counter__header">
                                <div class="vs-counter__number">
                                    <p class="main-counter__number">0</p>k+</div>
                            </div>
                            <h3 class="vs-counter__title">Trusted Clients</h3></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="vs-facts vs-facts--layout1 z-index-common overflow-hidden space-extra-bottom">
        ...
        <div class="container">
            <div class="row justify-content-between gy-3">
                ...
                <div class="col-xl-5 col-lg-6 col-md-5 z-index-common mb-30 vs-fade-in-up" data-duration="0.80" data-delay="0.3" data-scale="0.5" data-yposition="80">
                    <div><a href="https://www.youtube.com/watch?v=mQwIYf0xmV8" class="vs-portfolio__button vs-facts__video-button popup-video">Watch Video <i class="fa-regular fa-arrow-up-right"></i></a></div>
                </div>
            </div>
        </div>
    </section>
    <section class="vs-clients vs-clients--area space overflow-hidden">
        ...
        <div class="container">
            <div class="vs-clients__carousel vs-carousel swiper overflow-visible" data-xl="3" data-lg="2" data-md="1.5" data-autoplay="true" data-autoplay-delay="5000" data-loop="true" data-centered-slides="true" data-grab-cursor="true" dir="ltr">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="vs-clients__item">
                            ...
                            <h3 class="vs-clients__quote-title"><span><svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.756 0L15.9999 0.377358C15.8048 1.22356 15.5501 2.23556 15.2357 3.41338C14.9213 4.57976 14.5799 5.75186 14.2113 6.92967C13.8536 8.10749 13.4905 9.13093 13.1219 10H8.60156C8.76416 9.19954 8.92135 8.36478 9.07311 7.49571C9.23571 6.61521 9.38747 5.73471 9.52839 4.8542C9.66931 3.9737 9.79397 3.12178 9.90238 2.29846C10.0216 1.46369 10.1192 0.697541 10.1951 0H15.756Z" fill="currentColor"/><path d="M0.243903 10L0 9.62264C0.205962 8.77644 0.460705 7.77015 0.764228 6.60377C1.07859 5.42596 1.41463 4.24814 1.77236 3.07033C2.14092 1.88107 2.50949 0.857633 2.87805 0H7.39838C7.19242 1.06346 6.98103 2.18982 6.76423 3.37907C6.55827 4.56832 6.36857 5.73471 6.19513 6.87822C6.03252 8.02173 5.90244 9.06232 5.80488 10H0.243903Z" fill="currentColor"/></svg> </span>Lorem ipsum dolor sit a met!</h3>
                            <p class="vs-clients__quote">“Lorem ipsum dolor sit amet, consectetur adip iscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.”</p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="vs-clients__item">
    ...
    <section class="vs-portfolio vs-portfolio--area bg-theme-3 space z-index-common overflow-hidden">
        <div class="elements-of elements-of--portfolio1" data-ele-move="zoom" data-ele-move-speed="2"></div>
        <div class="elements-of elements-of--portfolio2" data-ele-move="zoom" data-ele-move-speed="2"></div>
        <div class="container">
            <div class="row justify-content-between align-items-end">
                <div class="col-lg-6">
                ...
                <div class="col-lg-auto text-center text-lg-end vs-fade-in-up" data-duration="1.3" data-delay="0.7" data-yposition="80" dir="ltr">
                    <div class="vs-portfolio__tabs d-flex flex-wrap justify-content-center">
    ...
    <section class="vs-blog--layout1 space space-extra-bottom" dir="ltr">
        <div class="container">
            ...
            <div class="vs-carousel swiper" data-xl="3" data-lg="2" data-md="2" data-space-xl="30" data-loop="false" data-autoplay="false">
                <div class="swiper-wrapper">
    ...
    <div class="vs-brand vs-brand--layout2 bg-theme-color-1 z-index-common overflow-hidden vs-fade-in-up" data-duration="1" data-yposition="80" data-scale="1" dir="ltr">
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-4 mb-30 vs-fade-in-up" data-duration="1" data-delay="0.3" data-yposition="80" data-scale="1">
                        <div class="vs-footer__widget">
                            ...
                            class="vs-subscribe mt-40" method="post">
        ...
        <div class="vs-footer__bottom">
            <div class="container">
                <div class="row justify-content-center justify-content-lg-between align-items-center gy-3 flex-column-reverse flex-lg-row">
                    ...
                    <div class="col-auto">
                        <div class="social-style style2"><a href="#"><i class="fab fa-facebook-f"></i></a> <a href="#"><i class="fab fa-linkedin-in"></i></a> <a href="#"><i class="fab fa-instagram"></i></a> <a href="#"><i class="fab fa-youtube"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
